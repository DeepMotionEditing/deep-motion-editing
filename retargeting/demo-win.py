...
def example(src_name, dest_name, bvh_name, test_type, output_path):
    ...
    input_file = os.getcwd()+'\\datasets\\Mixamo\\{}\\{}'.format(src_name, bvh_name)
    ref_file = os.getcwd()+'\\datasets\\Mixamo\\{}\\{}'.format(dest_name, bvh_name)
...
if __name__ == '__main__':
    example('Aj', 'BigVegas', 'Dancing Running Man.bvh', 'intra', os.getcwd()+'\\examples\\intra_structure')
    example('BigVegas', 'Mousey_m', 'Dual Weapon Combo.bvh', 'cross', os.getcwd()+'\\examples\\cross_structure')
    print('Finished!')
